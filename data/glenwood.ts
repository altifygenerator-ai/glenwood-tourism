...
export const glenwoodFeaturedLocalSpots = [
  {
    ...
    description: "A Glenwood favorite for breakfast, lunch, and comfort food close to the Caddo River.",
  ...
  },
  {
    ...
    description: "Known for seafood, fried fish, and casual family meals in the Glenwood area.",
  ...
  },
  {
    ...
    type: "Restaurant",
    badge: "Pizza & Italian",
    description: "A casual Glenwood stop for pizza, Italian food, and easy sit-down dining.",
  ...
  },
  {
    ...
    type: "Cabins & Camping",
    badge: "River Stay",
    description: "Cabins, camping, canoe rentals, and river access for Caddo River trips.",
  ...
  },
  {
    ...
    description: "Cabin and camping options near the Caddo River for weekend stays and outdoor trips.",
  ...
  },
  {
    ...
    type: "Lodging",
    badge: "Local Stay",
    description: "A simple local lodging option close to restaurants, shops, and outdoor spots in Glenwood.",
  ...
  },
  {
    ...
    description: "Get your cabin, restaurant, shop, or local business in front of visitors planning a Glenwood trip.",
