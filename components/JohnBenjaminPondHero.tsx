...
export default function JohnBenjaminPondHero() {
  const { hero } = johnBenjaminPondGuide;
  ...
  return (
    <section className="relative min-h-[82vh] flex items-center overflow-hidden dark-section">
      <div className="absolute inset-0 bg-[color:var(--color-accent)]">
        <img
          src={hero.image}
          alt="John Benjamin Glenwood Community Fishing Pond"
      ...
      <div className="container relative z-10 pt-20">
        <div className="max-w-3xl rounded-[2rem] border border-white/10 bg-black/70 p-8 text-white shadow-2xl backdrop-blur-md md:p-12">
          ...
          <div className="max-w-2xl text-lg leading-8 !text-white/80">
            {hero.subtitle}
          </div>
